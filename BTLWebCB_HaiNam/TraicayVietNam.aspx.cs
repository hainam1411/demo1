...
{
    public partial class TraicayVietNam : System.Web.UI.Page
    {
        ...
        public void hienDanhsach()
        {
            ...
            sanpham = sanpham.FindAll(sp => sp.loaiSanpham == 4);
            ...
            if (e.CommandName == "themgiohang")
            {
                ...
                if (id > 0)
                {
                    ...
                    if (giohang.Count > 0)
                    {
                        ...
                        Response.Write("<script>window.location='/TraicayVietNam.aspx';</script>");
                    }
                }
            }
        }
